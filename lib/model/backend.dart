...
class Backend {
  ...
  /// Lista privada de correos electrónicos. Codificado aquí para fines de prueba.
  final _emails = [
    Email(
      id: 631,
  ...
  /// Marca el correo electrónico identificado por su ID como leído.
  void markEmailAsRead(int id) {
    final index = _emails.indexWhere((email) => email.id == id);
    _emails[index].read = true;
  }

  /// Elimina el correo electrónico identificado por su id.
